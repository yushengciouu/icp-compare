...
| 風險等級 | 判定標準 | 合規應對與處置建議 |
| :--- | :--- | :--- |
| **🔴 High<br>(同一實體)** | 核心註冊品牌名稱完全對上，且包含街區、城市、物理地址等高度吻合。 | **立即攔截交易**。判定為同一被制裁實體，合規主管應進行系統凍結。 |
| **🟠 Medium<br>(關聯企業)** | • **名稱相同、國家不同**：被限制之境外關聯企業或海外子公司。<br>• **名稱不同、出貨地址完全重合**：在 Ship-To (出貨地址) 比對中，此類案件藏有極高之**第三方白手套規避制裁轉運風險**。 | **暫停交易並進入二審**。要求交易對象提供終極實質受益人（UBO）證明。 |
